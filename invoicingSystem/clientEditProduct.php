<?php
  ...
  $getProductId = $_GET['editProduct'];

  $productQuery = "SELECT * FROM clientproduct WHERE productId = '$getProductId'";
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <form method="POST" action="updateData.php">
                  ...
                  <input class="form-control"type="text" name="productName" value="<?php echo $productResult['productName']?>">

                  <br />

                  <label>Product Price</label>
                  <input class="form-control" type="text" name="productPrice" value="<?php echo $productResult['productPrice']?>">

                  <br />

                  <label>Product Description</label>
                  <input class="form-control" type="text" name="productDescription" value="<?php echo $productResult['productDescription']?>">

                  <br />

                  <input type="hidden" name="getNewProduct" value="<?php echo $productResult['productId']?>">
                  <button class="btn btn-success" type="submit" name="editProductButton">Edit</button>
                  <button class="btn btn-default" type="submit" name="editProductCancelBtn">Cancel</button>
